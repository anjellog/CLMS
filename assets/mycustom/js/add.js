...
$('.add_faculty').click(function(){
	...
	var mform = '<form class="add_frm_faculty">\
					...
					<div class="form-group">\
						<label>First Name</label>\
						<input type="text" name="f_fname" class="form-control text-capitalize" required autocomplete="off">\
					</div>\
					<div class="form-group">\
						<label>Last Name</label>\
						<input type="text" name="f_lname" class="form-control text-capitalize" required autocomplete="off">\
					</div>\
					<div class="form-group">\
						<label>Gender</label>\
